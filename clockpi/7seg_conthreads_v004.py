...
clock_id = '3' # int(read_oscID(filename))
print(f'clock_id is {clock_id}')

# IP ADDRESS
ipaddr = gethostbyname('clocks03.local')
...
osc_udp_server(ipaddr, 54321, 'clockpi_03')
osc_broadcast_server('10.0.10.255', 54322, 'clock_bc')
